...
### 🕊️ 天空聖殿・雷霆空襲(`skytemple.html`)
紀念碑谷風格粉彩幾何美術 × 雷電式縱向捲軸射擊(STG),操縱四軸無人機出擊。
三大關卡(天空聖殿/雲海迴廊/黃昏天城)各有專屬場景、色域、BGM 與難度;
無人機「穿環連鎖」加分(連 3 環送炸彈)、紅火神炮/藍雷射兩系武器 + P 強化(各 4 級)、
炸彈清屏、旋轉晶塔等六種敵人與三場 Boss 彈幕戰。過關解鎖接關,最高分保存於本機。
鍵盤(WASD/方向鍵+X 炸彈)與觸控拖曳皆可。
